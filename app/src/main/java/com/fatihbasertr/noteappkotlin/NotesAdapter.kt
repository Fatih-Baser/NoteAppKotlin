...
import com.fatihbasertr.noteappkotlin.databinding.ItemRvNoteBinding
import com.fatihbasertr.noteappkotlin.enum.ColorNoteType
import com.fatihbasertr.noteappkotlin.model.Note

import com.fatihbasertr.noteappkotlin.R
...
class NotesAdapter(private val context: Context?) : RecyclerView.Adapter<NotesAdapter.NoteViewHolder>() {
    ...
    override fun onBindViewHolder(holder: NoteViewHolder, position: Int) {
        ...
        layoutNote.setOnClickListener {
            val action = NotesFragmentDirections.actionNotesFragmentToAddNoteFragment(currentNote)
